...
function Inicio() {
    ...
    return (
        <>
            ...
            <Link to="/Explorar">
                <button className='bg-gradient-to-r from-cyan-500 to-cyan-600 hover:from-cyan-600 hover:to-cyan-700 text-gray-900 font-bold py-3 px-8 rounded-[10px] transition-all duration-300 transform hover:-translate-y-1 mb-[5vh] shadow-lg hover:shadow-cyan-500/50'>Explorar ahora</button>
            </Link>
            </section>
        </>
    )
